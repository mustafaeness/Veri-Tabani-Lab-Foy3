/*1.Soru: Database oluþturma */
CREATE DATABASE vtlabodev3 ON PRIMARY
(
NAME= vtlabodev3_data,
FILENAME = 'D:\vtlabodev3\vtlabodev3data.mfd',
SIZE = 8MB,
MAXSIZE = unlimited,
FILEGROWTH = 10%
)
...
(
NAME= vtlabodev3_log,
FILENAME = 'D:\vtlabodev3\vtlabodev.ldf',
SIZE = 8MB,
MAXSIZE = unlimited,
FILEGROWTH = 10%
)

/*1.Soru: Tablo oluþturma */
...
/*2. Soru: Tablolara eklenen verileri göstermek için sorgular */
